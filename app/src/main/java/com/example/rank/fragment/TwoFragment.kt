...
class TwoFragment : Fragment() {
    override fun onCreateView(
        ...
        val inflate = inflater.inflate(R.layout.rank_viewpager_item02,container,false)
        return inflate
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var fragmentList = listOf<Fragment>(charm_rank_day_fragment(),charm_rank_week_Fragment(),charm_rank_month_Fragment())
...
//                TODO("Not yet implemented")
    ...
    class RichRankViewPagerAdapter(fm: FragmentManager, val fragmentList:List<Fragment>):
